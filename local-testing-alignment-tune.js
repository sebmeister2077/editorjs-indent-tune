class AlignmentBlockTune {
    ...
    wrap(blockContent) {
        ...
        AlignmentBlockTune.listeners.forEach(l => l(this.block.id, this.data.alignment == 'right' ? 'rtl' : "ltr"))
    ...
    render() {
        ...
        this.alignmentSettings.map(align => {
            ...
            element.addEventListener('click', () => {
                const alignment = this.alignmentSettings[index].name
                this.data = {
                    alignment
                }
                ...
                AlignmentBlockTune.listeners.forEach(l => l(this.block.id, alignment == 'right' ? 'rtl' : "ltr"))
    ...
    static addChangeListener(l) {
        AlignmentBlockTune.listeners.add(l)
    }

    static removeChangeListener(l) {
        AlignmentBlockTune.listeners.delete(l);
    }
}

self.AlignmentBlockTune = AlignmentBlockTune
