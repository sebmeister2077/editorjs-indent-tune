import { EditorVersions, FeatureVersion } from "./EditorVersions"
...
export const EDITOR_VERSIONS: EditorVersions[keyof EditorVersions][] = [
    // Idk why but the old versions dont work at all anymore
    // "2.18", "2.18.0", '2.19', '2.19.0', '2.19.1', '2.19.2', '2.19.3',
    ...
    '2.29', '2.29.0', '2.29.1', '2.30', '2.30.1', '2.30.2', '2.30.3', '2.30.4', '2.30.5', '2.30.6', '2.30.7'
]
